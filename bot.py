...
async def handle_start(message: types.Message):
    ...
    text = (
        ...
        "Ти маєш бути підписаний на канал і запросити **мінімум 3 друзів**, щоб взяти участь.\n\n"
        "⚠️ Увага: твої друзі також мають підписатись на канал, і тільки тоді ти автоматично потрапиш до учасників.\n\n"
